...
const ROW_TYPE_BY_CATEGORY_AND_TYPE = {
  ...
  [DEVICE_FEATURE_CATEGORIES.TELEVISION]: {
    [DEVICE_FEATURE_TYPES.TELEVISION.VOLUME_MUTE]: BinaryDeviceFeature,
    [DEVICE_FEATURE_TYPES.TELEVISION.PLAY]: PushDeviceFeature,
    [DEVICE_FEATURE_TYPES.TELEVISION.PAUSE]: PushDeviceFeature,
    [DEVICE_FEATURE_TYPES.TELEVISION.STOP]: PushDeviceFeature,
    [DEVICE_FEATURE_TYPES.TELEVISION.PREVIOUS]: PushDeviceFeature,
    [DEVICE_FEATURE_TYPES.TELEVISION.NEXT]: PushDeviceFeature,
    [DEVICE_FEATURE_TYPES.TELEVISION.REWIND]: PushDeviceFeature,
    [DEVICE_FEATURE_TYPES.TELEVISION.FORWARD]: PushDeviceFeature
  }
};
